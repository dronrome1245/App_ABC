...
- [ ] **[AUDIO-02] Подготовка и интеграция обновлённого пакета аудио-ассетов букв v2 — IN PROGRESS / STUDIO ASSETS REQUIRED.**
  ...
  - [ ] добавить 33 реальные студийные letter OGG v2 с мягким, певучим и протяжным детским/педагогическим тембром;
  - [ ] проверить фактическую длительность каждого v2-ассета: целевой диапазон `400–700 мс` с допустимыми обоснованными отклонениями;
